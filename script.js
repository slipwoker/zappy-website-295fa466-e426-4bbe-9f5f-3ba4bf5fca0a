    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "effy event your self משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '295fa466-e426-4bbe-9f5f-3ba4bf5fca0a',
                    name: data.name || '',
                    email: data.email || '',
